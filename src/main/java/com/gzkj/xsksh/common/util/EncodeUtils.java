...
public class EncodeUtils {
    ...
    public static String decodeIgnore(String license){
        boolean hasUrlEncoded = hasUrlEncoded(license);
        System.out.println("hasUrlEncoded:"+hasUrlEncoded);
        license= hasUrlEncoded ==true? urlDecode(license):license;
        return license;
    }
