...
public class JFileUtils extends FileUtils {
     ...
     * 项目名称
     **/
    public static final String PROJECT_NAME = "/pptShow";
    /**
     * 文件上传的根目录
     **/
    public static final String FILE_UPLOAD_PATH = "/upload1";
    /**
     * 文件上传临时目录
     **/
     ...
     * 文件上传目录[图片]
     **/
    public static final String DIRECTORY_AVATAR = "/picture";
    /**
     * 文件上传目录[插图]
     **/
    public static final String DIRECTORY_DEPT = "/illustration";

    public static final String FILEPATHFILE = "uploadFiles/file/";        //文件上传路径

    private static Logger log = LoggerFactory.getLogger(JFileUtils.class);

    private static String datPath = YmlUtils.getYml("dat_path");
    private static ClassPathResource resource = new ClassPathResource(datPath);

    public static final String getRealFileUploadPath() {
        String tomcatRoot = System.getProperty("catalina.home") + "/webapps";
...
//        String path = JFileUtils.class.getResource("/static").getPath()+ "/map.dat";
    ...
    public static Object readObjectFromFile() {
        ...
        FileInputStream in;
        try {
            ObjectInputStream objIn = new ObjectInputStream(resource.getInputStream());
